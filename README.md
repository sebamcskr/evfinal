NOTA: la apliccación tuvo que ser reiniciada por errores de compilación en la versión original, debido a esto quedó como una app totalmente simple, pero cumpliendo los requerimientos mqtt y firebase
